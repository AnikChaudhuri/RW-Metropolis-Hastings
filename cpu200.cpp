...
int main(){
	...
	std::vector<double> ac(200);// current value of alpha1
	std::vector<double> bc(200);// current value of alpha2
	std::vector<double> cc(200);// current value of alpha3

	std::vector<double> r(200);// synthetic r
	std::vector<double> mu(200);// mean, used in generating r.

	//expression profile d1, d2, d3
	std::vector<int> d1(200);
	std::vector<int> d2(200);
	std::vector<int> d3(200);
	...
	std::vector<double> m_b(200);// used for calculating the parameters for 1/c^2.
	//gap, gbp, gcp are used for holding the generated gamma variables for alpha1, alpha2, alpha3.
	std::vector<double> gap(200);
	std::vector<double> gbp(200);
	std::vector<double> gcp(200);

	//apr, bpr, cpr are used for storing the proposals of alpha1, alpha2, alpha3
	std::vector<double> apr(200);
	std::vector<double> bpr(200);
	std::vector<double> cpr(200);

	std::vector<double> resp(200);//this holds the conditional prob. of proposed alpha 
	std::vector<double> resc(200);//this holds the conditional prob. of current alpha 
	...
	std::vector<double> rpk(200);//holds the result from function dch.
	std::vector<double> rc(200);//holds the result from function dch.
	...
	double c2a = (nu0 + 200.)/2.; double c_1; //c2a is the a parameter for 1/c^2
