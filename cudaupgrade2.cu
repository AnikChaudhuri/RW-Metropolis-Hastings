...
int main() {
    ...
    double c2b;//b parameter of 1/c^2
    //proposal K
    ...
    for(int j = 0; j<num; j++){
        ...
        c2b = (nu0*c20 + cb)/2.0;//computing b parameter for 1/c^2

        c_gamma<<<1, 1>>>(c2a, c2b, dv_Cg, count2, d_states );
        c_1 = Cg[0];
