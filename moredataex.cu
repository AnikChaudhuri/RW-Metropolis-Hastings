...
int main() {
    ...
    ifstream ifs("de.txt", ifstream::in);
			...
			ifstream ifu("de1.txt", ifstream::in);
			...
			ifstream ifv("de2.txt", ifstream::in);
            ...
            ifstream ifq("re.txt", ifstream::in);
